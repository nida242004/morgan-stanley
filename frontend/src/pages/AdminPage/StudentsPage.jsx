...
const StudentsPage = () => {
  ...
  const fetchStudentsAndDiagnoses = async () => {
    try {
      ...
      const [studentsRes, diagnosesRes] = await Promise.all([
        axios.get(
          "https://team-5-ishanyaindiafoundation.onrender.com/api/v1/admin/allStudents",
          {
            headers: { Authorization: `Bearer ${token}` },
          }
        ),
        axios.get(
          "https://team-5-ishanyaindiafoundation.onrender.com/api/v1/admin/diagnosis",
          {
            headers: { Authorization: `Bearer ${token}` },
          }
        ),
  ...
  const getDiagnosisName = (diagnosisID) => {
    if (!diagnosisID || !Array.isArray(diagnoses) || diagnoses.length === 0)
      return "N/A";
  ...
  const getStatusBadge = (status) => {
    switch (status) {
      ...
      default:
        return (
          <Badge className="student-status-badge" bg="secondary">
            {status}
          </Badge>
        );
    }
  ...
  const getPrimaryDiagnosisBadge = (diagnosisID) => {
    return (
      <Badge
        className="student-diagnosis-badge"
        style={{ backgroundColor: colors.killarney }}
      >
  ...
  const getComorbidityBadge = (diagnosisID) => {
    ...
    if (Array.isArray(diagnosisID)) {
      ...
      return diagnosisID.map((id, index) => (
        <Badge
          key={index}
          className="me-1 mb-1 student-comorbidity-badge"
          style={{ backgroundColor: colors.mulberry }}
        >
          {getDiagnosisName(id)}
        </Badge>
      ));
    ...
    return (
      <Badge
        className="student-comorbidity-badge"
        style={{ backgroundColor: colors.mulberry }}
      >
        {getDiagnosisName(diagnosisID)}
      </Badge>
  ...
  if (loading) {
    return (
      <div
        ...
        style={{ height: "80vh", backgroundColor: colors.pampas }}
      >
        <div
          className="spinner-border"
          role="status"
          style={{ color: colors.killarney }}
        >
          <span className="visually-hidden">Loading...</span>
        </div>
        <span className="ms-2" style={{ color: colors.killarney }}>
          Loading students...
        </span>
      </div>
    );
          ...
          <Card.Body>
            ...
            <Row className="mb-4 mt-4 align-items-end">
              <Col md={4}>
                <Form.Group>
                  <Form.Label
                    style={{ color: colors.killarney, fontWeight: "500" }}
                  >
                    Filter by Status
                  </Form.Label>
                  <Form.Select
                  ...
                  <Table hover responsive className="mb-0">
                    <thead style={{ backgroundColor: "#f8f8f8" }}>
                      <tr>
                        ...
                        <th style={{ color: colors.killarney }}>
                          Primary Diagnosis
                        </th>
                          ...
                          <td colSpan="7" className="text-center py-5">
                            <div className="text-muted empty-state">
                              ...
                              <p className="mb-0 mt-2">
                                No students found matching the selected
                                criteria.
                              </p>
                            </div>
                          </td>
                ...
                >
                  ...
                  <Card.Body style={{ padding: "1rem" }}>
                    <Row className="mb-2">
                      ...
                      <Col xs={7}>
                        <strong>
                          {selectedStudent.studentID || "Not Assigned"}
                        </strong>
                      </Col>
                    </Row>
                    <Row className="mb-2">
                    ...
                    <Row className="mb-2">
                      ...
                      <Col xs={7}>
                        {calculateAge(selectedStudent.dob)} years
                      </Col>
                    </Row>
                    <Row className="mb-2">
                      <Col xs={5} className="text-muted">
                      ...
                      <Col xs={7}>
                        {selectedStudent.bloodGroup || "Not Available"}
                      </Col>
                    </Row>
                    <Row>
                      <Col xs={5} className="text-muted">
                ...
                >
                  ...
                  <Card.Body style={{ padding: "1rem" }}>
                    ...
                    <Row className="mb-2">
                      ...
                      <Col xs={7}>
                        {selectedStudent.phoneNumber || "Not Available"}
                      </Col>
                    </Row>
                    <Row className="mb-2">
                      <Col xs={5} className="text-muted">
                      ...
                      <Col xs={7}>
                        {selectedStudent.secondaryPhoneNumber ||
                          "Not Available"}
                      </Col>
                    </Row>
                    <Row className="mb-2">
                      ...
                      <Col xs={7}>
                        {selectedStudent.parentEmail || "Not Available"}
                      </Col>
                    </Row>
                    <Row>
                      <Col xs={5} className="text-muted">
                  ...
                  <Card.Body style={{ padding: "1rem" }}>
                    ...
                    {selectedStudent.primaryDiagnosis && (
                      <Row className="mb-3">
                        <Col xs={12}>
                          <div
                            className="p-2 rounded diagnosis-description"
                            style={{
                    ...
                    <Row className="mb-3">
                      ...
                      <Col xs={7}>
                        {Array.isArray(selectedStudent.comorbidity) &&
                        selectedStudent.comorbidity.length > 0
                    ...
                    <Row>
                      ...
                      <Col xs={7}>
                        {selectedStudent.allergies || "None reported"}
                      </Col>
                    </Row>
                  </Card.Body>
                </Card>
                ...
                >
                  ...
                  <Card.Body style={{ padding: "1rem" }}>
                    <Row className="mb-2">
                      ...
                      <Col xs={7}>
                        {selectedStudent.transport ? "Yes" : "No"}
                      </Col>
                    </Row>
                    <Row className="mb-3">
                      <Col xs={12} className="text-muted mb-1">
                        Strengths:
                      </Col>
                      <Col xs={12}>
                        <div
                          className="p-2 rounded student-detail-text"
                          style={{
                            backgroundColor: "#f8f9fa",
                            fontSize: "0.9rem",
                          }}
